...
const GeocodeAPI = 'AIzaSyC61tK3i1jMooRSR9zdsjy6SLNIbtcbQbo';

var geocodeAddress = (geoaddress, callback) => {
    request({
        url: `https://maps.googleapis.com/maps/api/geocode/json?address=${geoaddress},+CA&key=${GeocodeAPI}&lim=1`,
        json: true,
    },(error, response, body)=>{
        if(error)
        {
